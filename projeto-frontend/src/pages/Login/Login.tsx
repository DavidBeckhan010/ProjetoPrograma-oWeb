...
export default function Login() {
  ...
  const handleReset = (e: React.FormEvent) => {
    e.preventDefault()
    alert('Se houver uma conta com este email, você receberá um link para redefinir sua senha.')
    setMode('login')
  }
      ...
      <div className={styles.card}>
        ...
        {mode === 'register' && (
          <form className={styles.form} onSubmit={handleRegister}>
            ...
            <div className={styles.roleRow}>
              ...
              <label className={styles.roleLabel}>
                <input type="radio" name="role" checked={role === 'prestador'} onChange={() => setRole('prestador')} />
                Prestador
              </label>
            </div>
        ...
        {mode === 'reset' && (
          <form className={styles.form} onSubmit={handleReset}>
            ...
            <p className={styles.hint}>Digite seu email para receber um link de redefinição.</p>
            <input
              className={styles.input}
              type="email"
              placeholder="Email"
              ...
              onChange={(e) => setEmail(e.target.value)}
            />
            <button className={styles.btn} type="submit">Enviar Link</button>
            <div className={styles.linkRow}>
              <button type="button" className={styles.linkBtn} onClick={() => setMode('login')}>
                Voltar ao login
              </button>
